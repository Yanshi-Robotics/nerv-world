# 2026-09-07 apt walkthrough event integration. Run from the nerv-world root.
...
from scenes.apt.interactivity import FRIDGE_XY
capture={}
BasePlayer=w.Player
...
w.run_viewer('apt','g1',1.25,0,True)
